...
A modern, highly interactive, and comprehensive Dungeons & Dragons 5th Edition character sheet built with Next.js 15. Designed for speed, clarity, and ease of use during your tabletop sessions.
...
- **Components**: Radix UI & Custom shadcn-inspired components
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Heihei03/dnd-character-sheet.git
...
This project uses content from the **Systems Reference Document 5.1** ("SRD 5.1") by Wizards of the Coast LLC, licensed under the [Creative Commons Attribution 4.0 International License (CC-BY-4.0)](https://creativecommons.org/licenses/by/4.0/legalcode).
